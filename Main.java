...
public class Main {
  ...
  x = sc.nextInt();
        ...
        switch (x){
            ...
            // часто бывает что программой умеют пользоваться только тот кто ее написал.
            // поэтому нужно предусматривать ситуации когда все пошло не по плану программиста.
            // тут, например, что делать если человек напишет 13? для этого в switch-e есть команда defualt.
        }
        }
